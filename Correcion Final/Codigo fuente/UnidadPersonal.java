...
public class UnidadPersonal extends JFrame{
	...
	public UnidadPersonal(String legajo,ConexionMySQL c){
		...
		try {
			...
			panelInspector.setBackground(Color.WHITE);
			...
			txtPatente.setText("");
			txtPatente.setBounds(515, 489, 86, 25);
		...
		try
		{
			...
			if(rs.next())
			{
				...
				JOptionPane.showMessageDialog(this,
						"No tiene autorizacion para labrar una multa en esta ubicaci�n");
			}
	...
	public void generarMultas(java.sql.Date fecha, String hora, int id , String calle, String altura) {
		try {
			...
			if (flag==1)
			{
				JOptionPane.showMessageDialog(this,"No corrresponde multar a la patente " + patenteslist,"Mensaje informativo",JOptionPane.INFORMATION_MESSAGE);
			}
			else if (flag>1)
			        {
	...
	protected void botonAgregarAccion(String p) {	
		...
		else JOptionPane.showMessageDialog(this,"La patente debe contener 6 caracteres.","Mensaje informativo",JOptionPane.INFORMATION_MESSAGE);
	}
